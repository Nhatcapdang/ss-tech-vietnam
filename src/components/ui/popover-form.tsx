  ...
  return (
    ...
    >
      <motion.button
        ...
        className="flex h-9 items-center border bg-primary px-3 text-sm font-medium outline-none"
      >
        <motion.span
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            layoutId={`${title}-wrapper`}
            className="absolute z-20 overflow-hidden bg-primary p-1 shadow-[0_0_0_1px_rgba(0,0,0,0.08),0px_1px_2px_rgba(0,0,0,0.04)] outline-none"
            ref={ref}
            style={{ borderRadius: 10, width, height }}
          >
            <motion.span
              aria-hidden
              className="absolute top-[17px] left-4 text-sm text-foreground"
              layoutId={`${title}-title`}
            ...
            {showCloseButton && (
              <div className="absolute -top-[5px] left-1/2 z-20 flex h-[26px] w-[12px] -translate-x-1/2 transform items-center justify-center">
                <button
                  ...
                  className="absolute z-10 -mt-1 flex h-[6px] w-[10px] items-center justify-center rounded-full text-primary hover:text-foreground focus:outline-none"
                  aria-label="Close"
                >
                  <ChevronUp />
                </button>
