      ...
      <DropdownMenu modal={false}>
        ...
        <DropdownMenuContent align="start" sideOffset={0} className="w-60">
          {column.getCanSort() && (
            <>
              <DropdownMenuCheckboxItem
                className="relative ltr:pr-8 ltr:pl-2 rtl:pr-2 rtl:pl-8 [&_svg]:text-muted-foreground [&>span:first-child]:ltr:start-auto [&>span:first-child]:ltr:end-2 [&>span:first-child]:rtl:start-2 [&>span:first-child]:rtl:end-auto"
...
function DataGridColumnResizerImpl<TData, TValue>({
  ...
  return (
    <div
      ...
      tabIndex={0}
      className={cn(
        "absolute -end-px top-0 z-50 h-full w-0.5 cursor-ew-resize touch-none bg-border transition-opacity select-none after:absolute after:inset-y-0 after:start-1/2 after:h-full after:w-[18px] after:-translate-x-1/2 after:content-[''] hover:bg-primary focus:bg-primary focus:outline-none rtl:after:translate-x-1/2",
