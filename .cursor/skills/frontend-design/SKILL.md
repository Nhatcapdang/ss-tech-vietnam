...
description: >-
  ...
  components, HTML/CSS layouts, or when styling or beautifying any web UI).
...
Guides creation of distinctive, production-grade frontend interfaces that
avoid generic "AI slop" aesthetics. Implement real working code with
...
This skill’s text and accompanying files are licensed under the terms in
...
- **Tone**: Pick an extreme: brutally minimal, maximalist chaos,
  ...
  industrial/utilitarian, etc. Use these for inspiration but design one that is
...
- Overused font families (Inter, Roboto, Arial, system fonts as the only
  choice)
...
for the context. **No design should be the same.** Vary light and dark themes,
fonts, and aesthetics. **Never** converge on common choices (for example Space
...
Remember: aim for extraordinary creative work—commit fully to a distinctive
vision and show what can be created when thinking outside the box.
