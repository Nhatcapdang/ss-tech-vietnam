 ...
 * });
 *
 * <div ref={ref}>{isIntersecting ? 'Intersecting' : 'Not intersecting'}</div>
 * ```
 */
export function useIntersectionObserver({
    ...
    const observer = new IntersectionObserver(
      (entries: IntersectionObserverEntry[]): void => {
        ...
        entries.forEach(entry => {
          ...
          if (callbackRef) {
            callbackRef(isIntersecting, entry)
          }
  ...
  }, [ref, root, rootMargin, frozen, freezeOnceVisible, threshold, callbackRef])
