...
const badgeVariants = cva(
  'relative inline-flex w-fit shrink-0 items-baseline justify-center border border-transparent font-medium whitespace-nowrap transition-shadow outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*=size-])]:size-3',
  {
    variants: {
      variant: {
...
function StatusBadge({
  ...
  const variant =
    statusVariants[label.toLowerCase() as keyof typeof statusVariants] ??
    'focus'
  return (
...
export { Badge, badgeVariants, StatusBadge, type BadgeProps }
