  ...
  return (
    ...
    >
      ...
      <TooltipArrowPrimitive
        className="size-3 fill-foreground data-[side='bottom']:translate-y-[1px] data-[side='left']:translate-x-[-1px] data-[side='right']:translate-x-[1px] data-[side='top']:translate-y-[-1px] rtl:data-[side='left']:-translate-x-[-1px] rtl:data-[side='right']:-translate-x-[1px]"
        tipRadius={2}
      />
    </TooltipContentPrimitive>
  )
