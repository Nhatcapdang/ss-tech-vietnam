...
export interface OptionMultipleSelect {
  value: string
  label: string
  disable?: boolean
...
interface GroupOption {
  [key: string]: OptionMultipleSelect[]
}

interface MultipleSelectorProps {
  value?: OptionMultipleSelect[]
  defaultOptions?: OptionMultipleSelect[]
  ...
  /** async search */
  onSearch?: (value: string) => Promise<OptionMultipleSelect[]>
   ...
   **/
  onSearchSync?: (value: string) => OptionMultipleSelect[]
  onChange?: (options: OptionMultipleSelect[]) => void
...
export interface MultipleSelectorRef {
  selectedValue: OptionMultipleSelect[]
...
function transToGroupOption(options: OptionMultipleSelect[], groupBy?: string) {
  if (options.length === 0) {
    return {}
  }
...
function isOptionsExist(
  groupOption: GroupOption,
  targetOption: OptionMultipleSelect[]
) {
...
const MultipleSelector = ({
  ...
  const [selected, setSelected] = React.useState<OptionMultipleSelect[]>(
    value || []
  )
