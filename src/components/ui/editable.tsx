...
function EditableLabel(props: EditableLabelProps) {
  ...
  return (
    <LabelPrimitive
      ...
      className={cn(
        "text-sm leading-none font-medium peer-disabled:cursor-not-allowed peer-disabled:opacity-70 data-required:after:ms-0.5 data-required:after:text-destructive data-required:after:content-['*']",
        className
      )}
    >
      {children}
...
function EditableInput(props: EditableInputProps) {
  ...
  const onBlur = React.useCallback(
    ...
    [isDisabled, isReadOnly, propsRef, context, value]
  )
