...
function TagsInputList({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        'flex min-h-8 w-full flex-wrap items-center gap-1.5 rounded-md border border-input bg-input/30 px-2.5 py-1 text-sm focus-within:ring-1 focus-within:ring-ring disabled:cursor-not-allowed disabled:opacity-50',
        className
      )}
      {...props}
    />
